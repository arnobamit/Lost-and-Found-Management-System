...
<body>
    ...
    <?php if (!empty($adminData['file'])): ?>
        <div class="center">
        <img src="../uploads/<?= htmlspecialchars($adminData['file']) ?>" alt="Profile Picture" style="max-width:150px; border-radius: 20%; margin-bottom: 20px;">
        </div>    
    <?php endif; ?>
